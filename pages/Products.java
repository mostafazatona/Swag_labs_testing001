...
public class Products {
    ...
    public void clickSLBpName() {
        clickElement(SL_Bp_Name);
    }

    public void clickSLBpImage() {
        clickElement(SL_Bp_Image);
    }

    public void clickSLBpAddToCartButton() {
        clickAddToCartButton(SL_Bp_Addtocartbutton);
    }

    public void removeSLBpProduct() {
        removeProduct(SL_Bp_removeproduct1);
    }

    public void clickSLBlName() {
        clickElement(SL_Bl_Name);
    }

    public void clickSLBlImage() {
        clickElement(SL_Bl_Image);
    }

    public void clickSLBlAddToCartButton() {
        clickAddToCartButton(SL_BL_Addtocartbutton2);
    }

    public void removeSLBlProduct() {
        removeProduct(SL_Bp_removeproduct2);
    }

    public void clickSLBTName() {
        clickElement(SL_BT_Name);
    }

    public void clickSLBTImage() {
        clickElement(SL_BT_Image);
    }

    public void clickSLBTAddToCartButton() {
        clickAddToCartButton(SL_BT_Addtocartbutton3);
    }

    public void removeSLBTProduct() {
        removeProduct(SL_Bp_removeproduct3);
    }

    public void clickSLFJName() {
        clickElement(SL_FJ_Name);
    }

    public void clickSLFJImage() {
        clickElement(SL_FJ_Image);
    }

    public void clickSLFJAddToCartButton() {
        clickAddToCartButton(SL_FJ_Addtocartbutton4);
    }

    public void removeSLFJProduct() {
        removeProduct(SL_Bp_removeproduct4);
    }

    public void clickSLOnesieName() {
        clickElement(SL_Onesie_Name);
    }

    public void clickSLOnesieImage() {
        clickElement(SL_Onesie_Image);
    }

    public void clickSLOnesieAddToCartButton() {
        clickAddToCartButton(SL_Onesie_Addtocartbutton5);
    }

    public void removeSLOnesieProduct() {
        removeProduct(SL_Bp_removeproduct5);
    }

    public void clickTestAllTheThingsName() {
        clickElement(Test_allTheThings_Name);
    }

    public void clickTestAllTheThingsImage() {
        clickElement(Test_allTheThings_Image);
    }

    public void clickTestAllTheThingsAddToCartButton() {
        clickAddToCartButton(Test_allTheThings_Addtocartbutton6);
    }

    public void removeTestAllTheThingsProduct() {
        removeProduct(SL_Bp_removeproduct6);
    }
}